...
Данный микросервис позволяет пользователям подавать заявки на участие в мероприятиях, а организаторам подтверждать или отклонять эти заявки.
...
• **PATCH** _/{registrationId}/status_ -  одобрение заявки на участие организаторами события;

• **PATCH** _/{registrationId}/status/decline_ - отклонение заявки на участие организаторами события;
...
• **GET** _/registrations/count_ - возвращает количество поданных заявок в разных статусах по eventId.
